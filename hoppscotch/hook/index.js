...
async function postInit(inputObj) {
    await inputObj.downloadRequest("https://serverless-devs-app-pkg.oss-cn-beijing.aliyuncs.com/hoppscotch.zip", 
        path.join(inputObj.targetPath, 'code/packages/hoppscotch-app/dist'), {  extract: true, strip: 1 }
    );
